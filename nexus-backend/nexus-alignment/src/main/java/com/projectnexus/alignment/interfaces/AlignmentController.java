 ...
 * <ul>
 *   <li>{@code @PreAuthorize("hasAnyRole('DOWNSTREAM_CONSUMER','UPSTREAM_ADMIN')")} for create/update</li>
 *   <li>{@code @PreAuthorize("hasAnyRole('DOWNSTREAM_CONSUMER','UPSTREAM_ADMIN','VIEWER')")} for read</li>
 * </ul>
 */
@RestController
